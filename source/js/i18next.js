!(function(t, e) {
        ...
        i = function(t, e) {
            ...
            if (Symbol.iterator in Object(t))
                return (function(t, e) {
                    ...
                    try {
                        for (
                            var s, a = t[Symbol.iterator](); !(o = (s = a.next()).done) &&
                            (n.push(s.value), !e || n.length !== e); o = !0
                        );
                    } catch (t) {
                        (r = !0), (i = t);
                    } finally {
        ...
        u = (function() {
            ...
            return (
                ...
                (t.prototype.emit = function(t) {
                    for (
                        var e = arguments.length, n = Array(e > 1 ? e - 1 : 0), o = 1; o < e; o++
                    )
                        n[o - 1] = arguments[o];
    ...
    function p(t, e, n) {
        ...
        for (
            var i = "string" != typeof e ? [].concat(e) : e.split("."); i.length > 1;
            ...
            return (
                ...
                (s.prototype.translate = function(e, o) {
                    ...
                    var i = o.keySeparator || this.options.keySeparator || ".",
                        ...
                        p =
                        o.appendNamespaceToCIMode || this.options.appendNamespaceToCIMode;
                    ...
                    var g = this.resolve(e, o),
                        ...
                        y =
                        void 0 !== o.joinArrays ? o.joinArrays : this.options.joinArrays;
                    if (
                        h &&
                        "string" != typeof h &&
                        "boolean" != typeof h &&
                        "number" != typeof h && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(
                            v,
                        ) < 0 &&
                        (!y || "[object Array]" !== v)
                    ) {
                ...
                (s.prototype.extendTranslation = function(t, e, o) {
                    ...
                    var i = o.replace && "string" != typeof o.replace ? o.replace : o;
                    this.options.interpolation.defaultVariables &&
                        (i = n({}, this.options.interpolation.defaultVariables, i)),
                        (t = this.interpolator.interpolate(t, i, o.lng || this.language)),
                        !1 !== o.nest &&
    ...
    var L = (function() {
        ...
        R = (function() {
            function t() {
                ...
                e(this, t), (this.logger = l.create("interpolator")), this.init(n, !0);
            }
            return (
                (t.prototype.init = function() {
                    ...
                    arguments[1] &&
                        ((this.options = t),
                            ...
                            (this.escape = (t.interpolation && t.interpolation.escape) || y)),
    ...
    var j = (function(t) {
            ...
            return (
                                    ...
                                    e.forEach(function(e) {
                                        ...
                                        if (i) o.loaded(t + "|" + e, n, i);
                                            ...
                                            var s =
                                                ...
                                                t +
                                                " via multiloading failed";
                                            o.loaded(t + "|" + e, s), o.logger.error(s);
                                        }
                                    });
                                });
                        }) :
                ...
                (s.prototype.loadOne = function(t) {
                    ...
                    this.read(s, a, "read", null, null, function(o, r) {
                        o &&
                            ...
                            r &&
                            e.logger.log(
                                n + "loaded namespace " + a + " for language " + s,
                                r,
                            ),
                            e.loaded(t, o, r);
                    });
                ...
                (s.prototype.saveMissing = function(t, e, o, r, i) {
                    ...
                    this.backend &&
                        this.backend.create &&
                        this.backend.create(t, e, o, r, null, n({}, s, {
                            isUpdate: i
                        })),
                                    ...
                                    if (Object.prototype.hasOwnProperty.call(e, n))
                                        for (var i in e[n])
                                            if (
                                                ...
                                                var a = e[n][i];
                                                a && r.store.addResourceBundle(n, i, a);
                                            }
                            o && o();
                        }) :
                        o && o();
    ...
    var P = (function(i) {
        function s() {
            ...
            if (
                ...
                var a;
                if (!o.options.initImmediate) return (a = o.init(t, n)), r(o, a);
                setTimeout(function() {
                    o.init(t, n);
                }, 0);
            }
        ...
        return (
                ...
                if (
                    ...
                    s.resourceStore.on("added removed", function(t, e) {
                        ...
                        s.backendConnector.on("*", function(e) {
                            for (
                                var n = arguments.length, o = Array(n > 1 ? n - 1 : 0), r = 1; r < n; r++
                            )
                                o[r - 1] = arguments[r];
            ...
            (s.prototype.getFixedT = function(e, o) {
                var r = this,
                    i = function e(o, i) {
                        for (
                            var s = arguments.length, a = Array(s > 2 ? s - 2 : 0), l = 2; l < s; l++
                        )
                            a[l - 2] = arguments[l];
                        var u = n({}, i);
                        return (
                ...
                return "string" == typeof e ? (i.lng = e) : (i.lngs = e), (i.ns = o), i;
            }),
            (s.prototype.t = function() {
                var t;
                return (
                    this.translator && (t = this.translator).translate.apply(t, arguments)
                );
            }),
