...
(L.Control.Coordinates = L.Control.extend({
    ...
    onAdd: function (a) {
        ...
        var c = (this._container = L.DomUtil.create("div", b));
        var d = this.options;
        (this._labelcontainer = L.DomUtil.create("div", "uiElement label", c)),
    ...
    _handleSubmit: function () {
        var a = L.NumberFormatter.createValidNumber(
            this._inputX.value,
            this.options.decimalSeperator,
        );
        var b = L.NumberFormatter.createValidNumber(
            this._inputY.value,
            this.options.decimalSeperator,
        );
        if (void 0 !== a && void 0 !== b) {
            var c = this._marker;
            c ||
                ((c = this._marker = L.marker()),
                c.on("click", this._clearMarker, this)),
                c.setLatLng(new L.LatLng(b, a)),
                c.addTo(this._map);
        }
    },
    expand: function () {
    ...
    _createCoordinateLabel: function (a) {
        ...
        var d = this.options;
        return (
            (b = d.labelFormatterLng
                ? d.labelFormatterLng(a.lng)
                : L.Util.template(d.labelTemplateLng, {
                      x: this._getNumber(a.lng, d),
                  })),
            (c = d.labelFormatterLat
                ? d.labelFormatterLat(a.lat)
                : L.Util.template(d.labelTemplateLat, {
    ...
    _getNumber: function (a, b) {
        var c;
        return (c = b.useDMS
            ? L.NumberFormatter.toDMS(a)
            : L.NumberFormatter.round(a, b.decimals, b.decimalSeperator));
    },
    collapse: function () {
        if (
            !this._showsCoordinates &&
    ...
    L.Map.addInitHook(function () {
        this.options.coordinateControl &&
