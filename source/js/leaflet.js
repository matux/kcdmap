...
!(function(t, i) {
    ...
    (P.prototype = {
        ...
        contains: function(t) {
            ...
            return (
                (t =
                    "number" == typeof t[0] || t instanceof x ? w(t) : b(t)) instanceof P ?
                ((i = t.min), (e = t.max)) :
                (i = e = t),
                i.x >= this.min.x &&
                e.x <= this.max.x &&
    ...
    var Ve = Ue.extend({
        ...
        tn = Je.extend({
            ...
            closestLayerPoint: function(t) {
                for (
                    var i, e, n = 1 / 0, o = null, s = Rt, r = 0, a = this._parts.length; r < a; r++
                )
        ...
        an = rn.extend({
            ...
            _initImage: function() {
                ...
                if (
                    ...
                    for (
                        var n = i.getElementsByTagName("source"), o = [], s = 0; s < n.length; s++
                    )
                        o.push(n[s].src);
        ...
        fn = mn.extend({
            ...
            _updatePoly: function(t, i) {
                if (this._drawing) {
                    ...
                    if (a) {
                        for (
                            this._drawnLayers[t._leaflet_id] = t, h.beginPath(), e = 0; e < a; e++
                        ) {
