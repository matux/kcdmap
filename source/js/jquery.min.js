/*! jQuery v3.1.1 | (c) jQuery Foundation | jquery.org/license */ !(function (
    ...
    var x = (function (a) {
        ...
        function za(a, b) {
            ...
            var f = function (f, g, h, i, k) {
                ...
                var y = (w += null == v ? 1 : Math.random() || 0.1);
                var z = x.length;
                for (
                    k && (j = g === n || g || k);
                    s !== z && null != (l = x[s]);
    ...
    var E;
    var F = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    var G = (r.fn.init = function (a, b, c) {
        var e;
        var f;
        if (!a) return this;
    ...
    var aa = new RegExp("^(?:([+-])=|)(" + _ + ")([a-z%]*)$", "i");
    var ba = ["Top", "Right", "Bottom", "Left"];
    var ca = function (a, b) {
        return (
            (a = b || a),
    ...
    function ea(a, b, c, d) {
        ...
        var k = (r.cssNumber[b] || ("px" !== j && +i)) && aa.exec(r.css(a, b));
        if (k && k[3] !== j) {
            (j = j || k[3]), (c = c || []), (k = +i || 1);
    ...
    var ra = /^key/;
    var sa = /^(?:mouse|pointer|contextmenu|drag|drop)|click/;
    var ta = /^([^.]*)(?:\.(.+)|)/;
    ...
    (r.event = {
        ...
        dispatch: function (a) {
            ...
            var j = (V.get(this, "events") || {})[b.type] || [];
    ...
    var Sa = ["Webkit", "Moz", "ms"];
    var Ta = d.createElement("div").style;
    ...
    function Xa(a, b, c) {
        ...
        var e = !0;
        var f = Ma(a);
        var g = "border-box" === r.css(a, "boxSizing", !1, f);
        if (
    ...
    function fb(a, b, c) {
        ...
        var n = {};
        var o = a.style;
        var p = a.nodeType && ca(a);
        var q = V.get(a, "fxshow");
        c.queue ||
    ...
    var tb = /\[\]$/;
    var ub = /\r?\n/g;
    var vb = /^(?:submit|button|image|reset|file)$/i;
    var wb = /^(?:input|select|textarea|keygen)/i;
    ...
    var Ab = /([?&])_=[^&]*/;
    var Bb = /^(.*?):[ \t]*([^\r\n]*)$/gm;
    var Cb = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/;
    var Db = /^(?:GET|HEAD)$/;
    var Eb = /^\/\//;
    var Fb = {};
    var Gb = {};
    var Hb = "*/".concat("*");
    var Ib = d.createElement("a");
    Ib.href = qb.href;
