...
!(function() {
    ...
    var l = {
            ...
            read: function(n) {
                for (
                    var e = n + "=", r = document.cookie.split(";"), t = 0; t < r.length; t++
                ) {
                    for (var u = r[t];
        ...
        c = {
                ...
                function(n) {
                    var e = function(n) {
                            ...
                            do {
                                ...
                                (s = ((3 & r) << 4) | ((t = n.charCodeAt(c++)) >> 4)),
                                (o = ((15 & t) << 2) | ((u = n.charCodeAt(c++)) >> 6)),
                                (i = 63 & u),
                                isNaN(t) ? (o = i = 64) : isNaN(u) && (i = 64),
                                    (l +=
                                        e.charAt(a) + e.charAt(s) + e.charAt(o) + e.charAt(i)),
                                    (r = t = u = ""),
                                    (a = s = o = i = "");
                            } while (c < n.length);
                            return l;
                        ...
                        r = function(n, e, t, u) {
                            ...
                            var a,
                                s = (function() {
                                    for (
                                        var n = arguments[0], e = 1; e < arguments.length; e++
                                    ) {
                                        var r = arguments[e];
                            ...
                            if (
                                ...
                                for (var i in (o.open(n, e, t.async), s))
                                    s.hasOwnProperty(i) && o.setRequestHeader(i, s[i]);
            ...
            cookie: "undefined" != typeof document ?
                l :
                {
                    create: function(n, e, r) {},
                    read: function(n) {
            ...
            detectLanguage: function() {
                ...
                "undefined" != typeof window &&
                    (!(function() {
                            for (
                                var n = window.location.search.substring(1).split("&"), r = 0; r < n.length; r++
                            ) {
                                var t = n[r].indexOf("=");
                                if (t > 0) {
    ...
    function f(e, a) {
        ...
        if (
            ("function" == typeof e && ((a = e), (e = {})),
                ...
                (o.interpolationPrefixEscaped = c.regexEscape(o.interpolationPrefix)),
                (o.interpolationSuffixEscaped = c.regexEscape(o.interpolationSuffix)),
                ...
                (function() {
                    function n(n, e, t) {
                        if (0 !== e.length) {
                            ...
                            if (0 === e.indexOf("[")) {
                                var s = e.split("]");
                                (e = s[1]), (a = s[0].substr(1, s[0].length - 1));
                            }
                    ...
                    function e(e, t) {
                        ...
                        if (u) {
                            ...
                            !0 === o.useDataAttrOptions && e.data("i18n-options", t);
                        }
                    }
                    (r.t = r.t || d),
            ...
            return (
                (u = o.resStore), a && a(d), i && i.resolve(), i ? i.promise() : void 0
            );
        var l = c.toLanguages(o.lng);
        "string" == typeof o.preload && (o.preload = [o.preload]);
        for (var f = 0, m = o.preload.length; f < m; f++)
            for (var p = c.toLanguages(o.preload[f]), b = 0, g = p.length; b < g; b++)
    ...
    function m(n, e) {
        var r = {
            ...
            a = c.toLanguages(o.lng);
        "string" == typeof o.preload && (o.preload = [o.preload]);
        for (var s = 0, i = o.preload.length; s < i; s++)
            for (var l = c.toLanguages(o.preload[s]), f = 0, m = l.length; f < m; f++)
                ...
                c.each(n, function(n, r) {
                    o.ns.namespaces.indexOf(r) < 0 && o.ns.namespaces.push(r),
                        c.each(p, function(n, i) {
                            ...
                            0 === --s &&
                                e &&
                                (o.useLocalStorage && t.sync._storeLocal(u), e());
                        });
                });
            }) :
            e && e();
        ...
        return (
            c.each(e, function(e, i) {
                ...
                n =
                    ...
                    (n = n.replace(new RegExp([u, l, s].join(""), "g"), i)).replace(
    ...
    function b(n, e) {
        ...
        for (
            ...
            var t = n.lastIndexOf(o.reusePrefix),
                u = n.indexOf(o.reuseSuffix, t) + o.reuseSuffix.length,
                s = n.substring(t, u),
                i = s.replace(o.reusePrefix, "").replace(o.reuseSuffix, "");
            if (-1 != i.indexOf(",")) {
                var l = i.indexOf(",");
    ...
    function h(n, e) {
        var r,
            ...
            .defaultValue || n,
            u = N(n, e),
            a = e.lng ? c.toLanguages(e.lng) : s,
            i = e.ns || o.ns.defaultNs;
        ...
        var f = t;
        if (
            (t.indexOf(o.nsseparator) > -1 && (f = (r = t.split(o.nsseparator))[1]),
    ...
    function N(n, e) {
        ...
        if (
            ...
            (delete(r = c.extend({}, e)).context,
                ...
                (a = d(g + o.nsseparator + n + "_" + e.context, r)) != o.contextNotFound)
        )
            return p(a, {
                context: e.context
            });
        if (
            (function(n) {
                return (
                    void 0 !== n.count && "string" != typeof n.count && 1 !== n.count
                );
            })(e)
        ) {
            delete(r = c.extend({}, e)).count, (r.defaultValue = o.pluralNotFound);
            var y = g + o.nsseparator + n + o.pluralSuffix,
                k = x.get(l[0], e.count);
            if (
                (k >= 0 ? (y = y + "_" + k) : 1 === k && (y = g + o.nsseparator + n),
        ...
        for (
            var S = n.split(o.keyseparator), O = 0, L = l.length; O < L && void 0 === m; O++
        ) {
                ...
                if ("string" == typeof T) T = b((T = p(T, e)), e);
                    ...
                    if (null === T && !0 === o.fallbackOnNull) T = void 0;
                        ...
                        if (o.returnObjectTrees || e.returnObjectTrees) {
                            var P = {};
                            for (var A in T)
                                P[A] = h(g + o.nsseparator + n + o.keyseparator + A, e);
                            T = P;
                        } else
                            (T =
                                "key '" +
                    ...
                    if ((m = N(o.fallbackNS[C] + o.nsseparator + n, e)))
                        if (
                            (m.indexOf(o.nsseparator) > -1 ?
                                ...
                                m) !==
                            (i.indexOf(o.nsseparator) > -1 ? i.split(o.nsseparator)[1] : i)
                        )
                            break;
                }
        else m = N(n, e);
    ...
    var v = {
            ...
            _storeLocal: function(n) {
                if (window.localStorage)
                    for (var e in n)
                        ...
                        window.localStorage.setItem("res_" + e, JSON.stringify(n[e]));
            },
            _fetch: function(n, e, r) {
                ...
                if (e.dynamicLoad) {
                    ...
                    var o,
                        i = t.namespaces.length * n.length;
                ...
                for (var m = 0, b = i.length; m < b; m++) {
                    ...
                    c.ajax({
                        ...
                        success: function(n, a, s) {
                            ...
                            for (var o = r.split("."), i = 0, l = u[d.lng][e]; o[i];)
                                (l =
                                    i === o.length - 1 ?
                                    (l[o[i]] = t) :
                                    (l[o[i]] = l[o[i]] || {})),
        ...
        x = {
            rules: {
                ...
                ro: {
                    ...
                    plurals: function(n) {
                        return Number(
                            1 == n ? 0 : 0 === n || (n % 100 > 0 && n % 100 < 20) ? 1 : 2,
                        );
                    },
                },
                ru: {
            ...
            return (
                (r.format = function(r, t) {
                    ...
                    for (a = 0; a < m; a++)
                        ...
                        if ((o = r[a])[2])
                            for (u = t[f], s = 0; s < o[2].length; s++) {
                                if (!u.hasOwnProperty(o[2][s]))
                                    throw S('[sprintf] property "%s" does not exist', o[2][s]);
                                u = u[o[2][s]];
                            }
                        else u = o[1] ? t[o[1]] : t[f++];
                        if (/[^s]/.test(o[8]) && "number" != n(u))
                            throw S("[sprintf] expecting number but found %s", n(u));
                        switch (o[8]) {
                            case "b":
                                u = u.toString(2);
                                break;
                            ...
                            case "o":
                                ...
                                break;
                            case "s":
                                u = (u = String(u)) && o[7] ? u.substring(0, o[7]) : u;
                                break;
                            case "u":
                                u = Math.abs(u);
                                break;
                        ...
                        (u = /[def]/.test(o[8]) && o[3] && u >= 0 ? "+" + u : u),
                        (l = o[4] ? ("0" == o[4] ? "0" : o[4].charAt(1)) : " "),
