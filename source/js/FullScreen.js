!(function() {
    (L.Control.FullScreen = L.Control.extend({
        ...
        onAdd: function(e) {
            var t,
                n = "leaflet-control-zoom-fullscreen",
                l = "";
            return (
                (t =
        ...
        _createButton: function(t, n, l, r, i, s) {
            return (
                ...
                .addListener(r, e.fullScreenEventName, L.DomEvent.preventDefault)
                .addListener(r, e.fullScreenEventName, this._handleEscKey, s),
                L.DomEvent.addListener(
                    document,
                    e.fullScreenEventName,
                    L.DomEvent.stopPropagation,
                ...
                .addListener(document, e.fullScreenEventName, this._handleEscKey, s),
                this.link
            );
        },
        toggleFullScreen: function() {
            ...
            (t._exitFired = !1),
            t._isFullscreen ?
                (e.supportsFullScreen && !this.options.forcePseudoFullscreen ?
                    e.cancelFullScreen(
        ...
        _handleEscKey: function() {
            ...
            e.isFullScreen(t) ||
                t._exitFired ||
                (t.fire("exitFullscreen"), (t._exitFired = !0), (t._isFullscreen = !1));
        },
    })),
    ...
    if (void 0 !== document.exitFullscreen) e.supportsFullScreen = !0;
        ...
        for (var n = 0, l = t.length; n < l; n++)
            if (
                ((e.prefix = t[n]), void 0 !== document[e.prefix + "CancelFullScreen"])
            ) {
