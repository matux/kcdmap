L.Map.mergeOptions({
    ...
    (L.Map.SmoothWheelZoom = L.Handler.extend({
        ...
        _onWheeling: function (o) {
            ...
            (this._goalZoom =
                this._goalZoom -
                0.003 * o.deltaY * t.options.smoothSensitivity),
                (this._goalZoom < t.getMinZoom() ||
                    this._goalZoom > t.getMaxZoom()) &&
                    (this._goalZoom = t._limitZoom(this._goalZoom)),
                (this._wheelMousePosition =
                    this._map.mouseEventToContainerPoint(o)),
                clearTimeout(this._timeoutId),
                (this._timeoutId = setTimeout(
                    this._onWheelEnd.bind(this),
                    200,
                ));
        },
        ...
        _updateWheelZoom: function () {
            ...
            if (
                ...
                (this._zoom =
                    o.getZoom() + 0.3 * (this._goalZoom - o.getZoom())),
