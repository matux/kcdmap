...
(L.Control.Sidebar = L.Control.extend({
    ...
    initialize: function(t, s) {
        ...
        for (
            ...
            i = this._sidebar.children.length - 1; i >= 0; i--
        )
        ...
        for (
            ...
            i = this._tabitems.length - 1; i >= 0; i--
        )
            this._tabitems[i]._sidebar = this;
        for (
            this._panes = [],
            this._closeButtons = [],
            i = this._container.children.length - 1; i >= 0; i--
        )
            if (
                ...
                this._panes.push(e);
                for (
                    var o = e.querySelectorAll(".sidebar-close"), a = 0, l = o.length; a < l; a++
                )
